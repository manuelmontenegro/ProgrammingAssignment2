...
##   returns the cached inverse; otherwise it computes the inverse and stores 
##   it in the object given as parameter.
...
## It the inverse has been computed before, it just retrieves the cached value
